...
export const EditorChart = forwardRef(({ dispatch, albums, highlighted, name, shape, size }, ref) => {
    ...
    return (_jsxs(Chart, { ref: ref, name: name, children: [_jsx(EditorAlbumRows, { dispatch: dispatch, rows: rows, highlighted: highlighted }, void 0), _jsx(EditorAlbumTitles, { dispatch: dispatch, groups: groups, highlighted: highlighted }, void 0)] }, void 0));
});
