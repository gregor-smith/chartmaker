...
export const ControlledRadioButton = ({ id, checked, onCheck, children }) => {
    ...
    return (_jsxs("div", { className: containerClassName, children: [_jsx("input", { id: id, style: inputStyle, type: 'radio', checked: checked, onChange: onCheck }, void 0), _jsx(Label, { target: id, children: children }, void 0)] }, void 0));
};
