...
export const ViewerChart = forwardRef(({ dispatch, albums, highlighted, name, shape, size }, ref) => {
    ...
    return (_jsxs(Chart, { ref: ref, name: name, children: [_jsx(ViewerAlbumRows, { dispatch: dispatch, rows: rows, highlighted: highlighted }, void 0), _jsx(ViewerAlbumTitles, { dispatch: dispatch, groups: groups, highlighted: highlighted }, void 0)] }, void 0));
});
