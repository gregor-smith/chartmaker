...
export const ChartShapeControls = ({ dispatch, shape: [rowsX, rowsY], size }) => {
    ...
    if (size === null) {
        ...
        rowsXSlider = (_jsx(ControlledSlider, { id: 'rows-x', min: CollageDimension.alternatives[0].value, max: CollageDimension.alternatives[CollageDimension.alternatives.length - 1].value, step: 1, value: rowsX, onChange: updateRowsX, children: "X" }, void 0));
        rowsYSlider = (_jsx(ControlledSlider, { id: 'rows-y', min: CollageDimension.alternatives[0].value, max: CollageDimension.alternatives[CollageDimension.alternatives.length - 1].value, step: 1, value: rowsY, onChange: updateRowsY, children: "Y" }, void 0));
    }
    return (_jsxs(SidebarGroup, { children: [_jsxs("div", { style: style, children: [_jsx(ControlledRadioButton, { id: 'top40', checked: size === 40, onCheck: switchToTop40, children: "Top 40" }, void 0), _jsx(ControlledRadioButton, { id: 'top42', checked: size === 42, onCheck: switchToTop42, children: "Top 42" }, void 0), _jsx(ControlledRadioButton, { id: 'top100', checked: size === 100, onCheck: switchToTop100, children: "Top 100" }, void 0), _jsx(ControlledRadioButton, { id: 'collage', checked: size === null, onCheck: switchToCollage, children: "Collage" }, void 0)] }, void 0), rowsXSlider, rowsYSlider] }, void 0));
};
