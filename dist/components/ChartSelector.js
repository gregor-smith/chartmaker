...
export const ChartSelector = ({ dispatch, charts, activeChartIndex }) => {
    ...
    return (_jsxs("div", Object.assign({ className: containerStyle }, { children: [_jsx(Label, Object.assign({ target: id }, { children: "Active chart" }), void 0), _jsx(ControlledSelect, Object.assign({ id: id, value: activeChartIndex, onChange: updateActiveChart }, { children: options }), void 0)] }), void 0));
};
